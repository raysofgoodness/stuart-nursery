export const activityCustomCursor = () => {
  ...
  class BigCircle {
    constructor() {
      ...
      if (CSS.supports("backdrop-filter", "invert(1) grayscale(1)")) {
        ...
        this.circleStyle.backgroundColor = '#386641'
        this.circleStyle.opacity = '0.4'
        this.dotStyle.backdropFilter = 'invert(1) grayscale(1)'
        this.dotStyle.backgroundColor = '#ffd401'
        this.dotStyle.opacity = '0.6'
      } else {
